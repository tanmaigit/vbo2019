...
function wfu_process_files($params, $method) {
	...
	$params_output_array["general"]['redirect_link'] = ( $params["redirect"] == "true" ? get_site_url().$params["redirectlink"] : "" );
			...
			if ( is_uploaded_file($fileprops['tmp_name']) || $only_check ) {
				...
				if ( $file_copied ) {
					...
					if ( $params["redirect"] == "true" ) {
						...
						$params_output_array["general"]['redirect_link'] = get_site_url().trim(preg_replace($search, $replace, $params["redirectlink"]));
					}
